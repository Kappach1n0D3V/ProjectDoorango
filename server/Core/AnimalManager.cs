...
public class AnimalManager
{
    ...
    {
        AnimalMotions.Motions motions = AnimalMotions.Of(animal.EntityType);
        // Keep legacy movement when the client assets do not identify a unique run clip.
        string motion = string.IsNullOrEmpty(motions?.Run) ? motions?.Move : motions.Run;
        if (string.IsNullOrEmpty(motion)) return default;
